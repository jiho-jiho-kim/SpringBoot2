...
function getCategory_List(e) {
	...
	if(obj.category_lv == 1 || obj.category_lv == 2) {
		...
		//클릯한 대상에 data-set값이 obj에 있습니다
		//console.log(JSON.stringify({"group_id" : obj.group_id, "category_lv" : obj.category_lv, "category_detail_lv" : obj.category_detail_lv}));
